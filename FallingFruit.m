...
s.imin = 4; % minimum rate of fall
s.imax = 7; % maximum rate of fall 
...
% -------------------------------------------------------------------------
instruct = sprintf(['You will see shapes falling from the top of the screen.\n',...
...
[wordRects, textBounds] = makeRectsFromWord('laall', params.Xc, params.Yc+200);
penWidthPixels = 1;
Screen('FrameRect', params.win, s.colors(1,:), wordRects, penWidthPixels);
